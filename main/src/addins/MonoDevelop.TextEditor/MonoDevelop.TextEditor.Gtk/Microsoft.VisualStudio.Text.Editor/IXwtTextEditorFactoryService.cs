...
namespace Microsoft.VisualStudio.Text.Editor
{
    ...
    /// </remarks>
    public interface IXwtTextEditorFactoryService
    {
        /// <summary>
        /// Creates an <see cref="IXwtTextView"/> that displays the contents of <paramref name="viewModel"/>.
        /// </summary>
        ...
        /// <returns>An <see cref="IXwtTextView"/>.</returns>
        ...
        IXwtTextView CreateTextView(ITextViewModel viewModel, ITextViewRoleSet roles, IEditorOptions parentOptions);

        /// <summary>
        /// Creates an <see cref="IXwtTextView"/> that displays the contents of <paramref name="dataModel"/>.
        /// </summary>
        ...
        IXwtTextView CreateTextView(ITextDataModel dataModel, ITextViewRoleSet roles, IEditorOptions parentOptions);

        /// <summary>
        /// Creates an <see cref="IXwtTextView"/> that displays the contents of <paramref name="textBuffer"/>.
        /// </summary>
        ...
        IXwtTextView CreateTextView(ITextBuffer textBuffer, ITextViewRoleSet roles, IEditorOptions parentOptions);
        ...
        IXwtTextView CreateTextView(ITextBuffer textBuffer, ITextViewRoleSet roles);

        /// <summary>
        /// Creates an <see cref="IXwtTextView"/> that displays the contents of <paramref name="textBuffer"/>.
        /// </summary>
        /// <param name="textBuffer">The <see cref="ITextBuffer"/> that provides the text for the view.</param>
        /// <returns>An <see cref="IXwtTextView"/> having the default set of text view roles.</returns>
        /// <remarks>
        /// An <see cref="ITextBuffer"/> can be displayed in multiple views. A trivial <see cref="ITextDataModel"/> will be constructed and
        /// an <see cref="ITextViewModel"/> will be constructed based on
        ...
        IXwtTextView CreateTextView(ITextBuffer textBuffer);

        /// <summary>
        /// Creates an <see cref="IXwtTextView"/> on a newly created <see cref="ITextBuffer"/> having
        /// content type <code>Text</code>.
        /// </summary>
        /// <returns>A <see cref="IXwtTextView"/>.</returns>
        IXwtTextView CreateTextView();

        /// <summary>
        /// Creates a host for the text view.
        /// </summary>
        /// <param name="textView">The text view to host.</param>
        /// <param name="setFocus"><c>true</c> if the <see cref="IXwtTextViewHost"/> should take focus after it is initialized, <c>false</c> otherwise.</param>
        /// <returns>An <see cref="IXwtTextViewHost"/>.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="textView"/> is null.</exception>
        IXwtTextViewHost CreateTextViewHost(IXwtTextView textView, bool setFocus);
